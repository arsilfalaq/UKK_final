...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/admin/master_barang/{id}/edit', [MasterBarangController::class, 'edit'])->name('master_barang.edit');
    Route::put('/admin/master_barang/{id}', [MasterBarangController::class, 'update'])->name('master_barang.update');
    Route::delete('/admin/master_barang/{id}', [MasterBarangController::class, 'destroy'])->name('master_barang.destroy');

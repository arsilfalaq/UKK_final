        ...
        <tbody>
            @foreach ($data as $barang)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('master_barang.edit', $barang->id_barang) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('master_barang.destroy', $barang->id_barang) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
